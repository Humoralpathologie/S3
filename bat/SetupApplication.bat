...
:: Android packaging
set AND_CERT_NAME="StarlingSnake"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\StarlingSnake.p12
set AND_ICONS=icons/android

set AND_SIGNING_OPTIONS=-storetype pkcs12 -keystore "%AND_CERT_FILE%" -storepass %AND_CERT_PASS%

:: iOS packaging
set IOS_DIST_CERT_FILE=cert\iphone_distribution.p12
set IOS_DEV_CERT_FILE=cert\iOS_dev.p12
set IOS_DEV_CERT_PASS=""
::set IOS_PROVISION=cert\LSvsTADK_production.mobileprovision
set IOS_PROVISION=cert\StarlingSnake.mobileprovision
...
set APP_ID=com.test.lsvstadk

:: Output packages
set DIST_PATH=dist
set DIST_NAME=LSvsTADK

:: Debugging using a custom IP
set DEBUG_IP=134.2.85.47
