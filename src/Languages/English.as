package Languages
{
    ...
    public static const ARCADEINFOHEADING:String = "ARCADE INFO";
		public static const ARCADEINFO:String = "This mode is all about earning the highest score by experimenting with different combos.\nThe Time Attack Mode gives you 3 minutes to help Little Snake devour as many eggs as possible before the volcano erupts. In addition to the basic combos, there are 3 slots which you can assign special combos to by tapping them.\nIf you are too chicken and afraid of volcanoes, you might want to try the Endless Mode. There you can slow down if you get too fast and go after the ultimate high score. Face the challenge for immortality in the Leaderboards.";
		// Combo Menu
		...
		public static const XTRALIFEDESC:String = "Extra Life:  This combo does exactly what you'd think.";
		...
		public static const NOROTTENDESC:String = "No Rotten Egg Combo: Performing this combo rids you of the bothersome poisonous eggs.";
    ...
    public static const OBJECTIVE:String = "Objective";
		...
		public static const LEVEL2A:String = "Devour 7 combos of at least 3 blue eggs!!\n\nStory:\nLittle Snake could squeeze oodles of eggs in his expandable gut, but he found the blue ones to be especially digestible when eaten in succession in greater quantities.\n\nMedal Requirements:\nBronze: 500 Points\nSilver: 750 Points\nGold: 1000 Points";
		public static const LEVEL2B:String = "Devour 10 combos of at least 3 blue eggs!!\n\nStory:\nLittle Snake could squeeze oodles of eggs in his expandable gut, but he found the blue ones to be especially digestible when eaten in succession in greater quantities.\n\nMedal Requirements:\nBronze: 1250 Points\nSilver: 2000 Points\nGold: 2500 Points";
		public static const LEVEL3A:String = "Get Little Snake sobered up - either by surviving for 4 minutes or by getting 7 combos. From now on eating more than 4 gray eggs will kill you!!\n\nStory:\nOn a quest for revenge you often have to act on a whim. So you have to forgive our hero for not knowing about the high toxicity of the gray eggs and falling into a ferocious delirium. Though his mind was clouded, Little Snake swore solemnly that from that point on he would avoid any gray eggs.\n\nMedal Requirements:\nBronze: 500 Points\nSilver: 750 Points\nGold: 900 Points";
		...
		public static const LEVEL5A:String = "Avoid the spikes for 3 minutes. If the Rotten Eggs get in your way, try a combo with the new eggs\n\nStory:\nLittle Snake heroicaly jumped the canyon only to find these ghastly spikes - but they won't hold him back!\n\nMedal Requirements:\nBronze: 750 Points\nSilver: 1000 Points\nGold: 1250 Points";
		public static const LEVEL5B:String = "Avoid the spikes for 3 minutes. If the Rotten Eggs get in your way, try a combo with the new eggs\n\nStory:\nLittle Snake heroicaly jumped the canyon only to find these ghastly spikes - but they won't hold him back!\n\nMedal Requirements:\nBronze: 1000 Points\nSilver: 1250 Points\nGold: 1500 Points";
		public static const LEVEL6A:String = "Eat 2 chains of at least 10 eggs & don't stop eating for longer than 14 seconds. \nHINT:\n You keep a chain going by eating the next egg before the little bar above our hero's head disappears.\n\nStory:\nHaving devoured loads of dino eggs, Little Snake was no longer just driven by the lust for revenge - he had developed a serious egg addiction. Don't let withdrawal get to him!\n\nMedal Requirements:\nBronze: 450 Points\nSilver: 750 Points\nGold: 1050 Points";
		public static const LEVEL6B:String = "Eat 3 chains of at least 10 eggs & don't stop eating for longer than 8 seconds. \nHINT:\n You keep a chain going by eating the next egg before the little bar above our hero's head disappears.\n\nStory:\nHaving devoured loads of dino eggs, Little Snake was no longer just driven by the lust for revenge - he had developed a serious egg addiction. Don't let withdrawal get to him!\n\nMedal Requirements:\nBronze: 1250 Points\nSilver: 1500 Points\nGold: 1750 Points";
		public static const LEVEL7A:String = "What's the deal with those special eggs? Make them disappear all at once!\n\nStory:\nAt long last Little Snake has found the Terror Triceratops. The wimp had hidden himself away in his castle of cowardice. Unfortunately our hero could not be bothered to find a way to circumvent the defences so long as those golden eggs glowed so deliciously in the evening sun.\n\nMedal Requirements:\nBronze: 1200 Points\nSilver: 1500 Points\nGold: 1800 Points";
    ...
    public static const NO_SCORES:String = "No scores yet!";        
    ...
    public static const EXTRATIMEEXTENDMESSAGE:String = "Bonus Time-";
    ...
    public static const HINTS:Array = ["Pay attention to the bonus scoring. Longer combos and chains score big time!",
      ...
      "You finished the Story Mode? Excellent - now go and learn new combos in the Arcade Mode to earn even higher scores!",
      
      "You think you've seen it all? There is an old saying that the player who sleeps in a golden bed has sapphire dreams!",
