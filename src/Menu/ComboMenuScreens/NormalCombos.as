package Menu.ComboMenuScreens
{
  ...
  public class NormalCombos extends Screen
  {
    ...
    override protected function initialize():void {
      ...
      var speed:Image = new Image(AssetRegistry.MenuAtlasAlpha.getTexture("combo-speed"));
      speed.x = 40;
      speed.y = 40;
      ...
      if (SaveGame.endless){
        secondCombo = new Image(AssetRegistry.MenuAtlasAlpha.getTexture("combo-time"));
        ...
        secondCombo = new Image(AssetRegistry.MenuAtlasAlpha.getTexture("combo-slower"));
      ...
      var norotten:Image = new Image(AssetRegistry.MenuAtlasAlpha.getTexture("combo-rotteneggs"));
      norotten.x = speed.x;
