package Level
{
  ...
  public class LevelState extends ManagedStage
  {
    ...
    private function showParticles(egg:DisplayObject):void
    {
      ...
      pd = _particles["combo"];
      pd.x = egg.x + egg.width / 2;
      pd.y = egg.y + egg.height / 2;
      pd.start(0.5);
    /*
       var pd:ParticleSystem;
