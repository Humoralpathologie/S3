    ...
    override protected function winScreenTouch(event:TouchEvent):void
    {
      ...
      if (touch)
      {
        ...
        if (!SaveGame.hasFinishedGame)
        {
          ...
          dispatchEventWith(ManagedStage.SWITCHING, true, {stage: VideoPlayer, args: {stage: VideoPlayer, videoURI: "Outro.mp4", args: {videoURI: "Credits.mp4", stage: LevelScore, args: score}}});
